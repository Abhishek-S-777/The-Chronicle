...
import 'package:thechronicle/main.dart';
...
class DatabaseManager {
  ...
  final CollectionReference profileList1 = FirebaseFirestore.instance.collection('hero');
  ...
  //Adding chronicle hero data to the database..
  Future<void> createHeroData(String name, String email, String password, String phno, String uImageUrl, String uid) async {
    await respawn.sharedPreferences.setString(respawn.userUID, uid);
    await respawn.sharedPreferences.setString(respawn.userName, name);
    await respawn.sharedPreferences.setString(respawn.userEmail, email);
    await respawn.sharedPreferences.setString(respawn.userPhno, phno);
    await respawn.sharedPreferences.setString(respawn.userAvatarUrl, uImageUrl);
    return await profileList1.doc(uid).set({
      'name': name,
      'email': email,
      'phoneNumber': phno,
      'url': uImageUrl,
