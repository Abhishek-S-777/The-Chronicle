...
import 'package:thechronicle/src/Animation/FadeAnimation.dart';
import 'package:flutter/material.dart';
import 'package:email_validator/email_validator.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:flashlight/flashlight.dart';
import 'package:thechronicle/src/DialogueBoxes/errorDialog.dart';
import 'package:thechronicle/src/DialogueBoxes/spinners.dart';
import 'package:thechronicle/src/chroniclehero/cherosignup.dart';
...
import 'package:thechronicle/src/Services/AuthenticationService.dart';
import 'package:thechronicle/src/pages/forgotpassword.dart';
import 'package:thechronicle/src/pages/login.dart';

class HeroLogin extends StatefulWidget{
	@override
	_HeroLoginState createState() => new _HeroLoginState();
}
...
class _HeroLoginState extends State<HeroLogin> {
	...
	bool hasflashlight = false; //to check if there is a flashlight ?
	bool isturnon = false; //to set the flash light on or off
  ...
  Widget build(BuildContext context) {
	            ...
	            Container(
	              ...
	              decoration: BoxDecoration(
	                image: DecorationImage(
	                  image: AssetImage('assets/newspapers/newspaper.jpg'),
	                  fit: BoxFit.cover
	                )
	              ),
	              child: Stack(
	                children: <Widget>[
	                  ...
	                  Positioned(
	                    ...
	                    child: FadeAnimation(1.6, Container(
	                      ...
	                      child: Center(
	                        child: Text("Chronicle hero!", style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),),
	                      ),
	                    )),
	                  )
	                ],
	            ...
	            Padding(
	              ...
	              child: Column(
	                ...
	                SizedBox(height: 15,),
	                  InkWell(
											onTap:  () {
												Route route = MaterialPageRoute(builder: (c) => HeroSignup());
												Navigator.push(context, route);
											},
	                    child:
											FadeAnimation(1.5,
													Text("Not a member? Register now", style: TextStyle(color: Colors.white),)),
	                  ...
	                  InkWell(
	                    ...
	                    child:
											FadeAnimation(1.5,
													Text("I'm an User!", style: TextStyle(color: Color.fromRGBO(36, 39, 99, 1.0)),)),
	...
	void signInUser() async {
		...
		dynamic authResult =
		await _authservice.loginHeroUser(_uemailController.text, _upassController.text);
		...
		if (authResult == null) {
			...
			Route route = MaterialPageRoute(builder: (c) => HeroNavigationHomeScreen());
