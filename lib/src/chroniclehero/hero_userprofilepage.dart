...
class MapScreenState extends State<HeroProfilePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    _imageUrl=respawn.sharedPreferences.getString(respawn.heroAvatarUrl);
    print("Current user id is "+respawn.sharedPreferences.getString(respawn.heroUID));
    return Form(
      key: _formKey,
      child: new Scaffold(
          body: new Container(
          ...
          decoration: new BoxDecoration(
            ...
            image: new DecorationImage(
              image: new NetworkImage(
                  respawn.sharedPreferences.getString(respawn.heroAvatarUrl)
              ),
              fit: BoxFit.cover,
            ),
          )
  ...
  uploadImageAndSaveItemInfo() async
  {
    ...
    if(_imageFile!=null){
      ...
      Reference storageReference = FirebaseStorage.instance.refFromURL(respawn.sharedPreferences.getString(respawn.heroAvatarUrl));
  ...
  {
    String userID= respawn.sharedPreferences.getString(respawn.heroUID) ;
  ...
  saveProductInfo({String downloadURL})
  {
    if(_formKey.currentState.validate()){
      ...
      final itemsRef = FirebaseFirestore.instance.collection("hero");
      itemsRef.doc(respawn.sharedPreferences.getString(respawn.heroUID)).update({
