...
import 'package:thechronicle/src/config/route.dart';
...
class HeroSignup extends StatefulWidget {
  ...
  @override
  _HeroSignupState createState() => _HeroSignupState();
}
...
class _HeroSignupState extends State<HeroSignup> {
  ...
  Widget build(BuildContext context) {
	            ...
	            Container(
	              ...
	              decoration: BoxDecoration(
	                image: DecorationImage(
	                  image: AssetImage('assets/newspapers/newspaper2.jpg'),
	                  fit: BoxFit.cover
	                )
	              ),
	              child: Stack(
	              ...
	              child: Column(
	                children: <Widget>[
	                  ...
	                  InkWell(
	                    ...
	                    child: FadeAnimation(1.5, Text("Already a member? Sign in", style: TextStyle(color: Colors.black),),
										),
	                  ),
	                ],
	              ),
	...
	void createUser() async {
		...
		dynamic result = await _authservice.createNewHero(
		...
		if (result == null) {
			...
			Route route = MaterialPageRoute(builder: (c) => HeroLogin());
