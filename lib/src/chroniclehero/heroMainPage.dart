...
import 'package:thechronicle/src/appbar/customappbar.dart';
import 'package:thechronicle/src/chroniclehero/hero_home_page.dart';
...
import 'package:thechronicle/src/pages/wishlist.dart';
...
import 'package:thechronicle/src/troubleshooting/instructions.dart';
import 'package:thechronicle/src/widgets/BottomNavigationBar/bottom_navigation_bar.dart';
...
class HeroMainPage extends StatefulWidget {
  HeroMainPage({Key key, this.title}) : super(key: key);
                            ...
                            builder: (context, counter, _ )
                            {
                              ...
                              return Center (
                                child: Text (
                                  ...
                                  style: TextStyle(color: Colors.deepOrange, fontSize: 12.0, fontWeight: FontWeight.w500),
                                ),
                              );
                            },
                          ),
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: AnimatedSwitcher(
                        ...
                        child: isHomePageSelected ? HeroHomePage() : isServicePageSelected? Instructions(isPaymentSuccess:false) : isWishlistPageSelected? WishlistPage() : Align(
