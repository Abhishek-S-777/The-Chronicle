...
import 'hero_home_drawer.dart';

class HeroDrawerUserController extends StatefulWidget {
  const HeroDrawerUserController({
    Key key,
  ...
  final Function(HomeDrawerIndex) onDrawerCall;
  ...
  @override
  _HeroDrawerUserControllerState createState() => _HeroDrawerUserControllerState();
}

class _HeroDrawerUserControllerState extends State<HeroDrawerUserController> with TickerProviderStateMixin {
