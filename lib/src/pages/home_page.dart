  ...
  Widget sourceInfo(ItemModel model, BuildContext context,
    ...
    return SafeArea(
      child: InkWell(
        onTap: ()
        {
          print("model is "+model.issue.toString());
                        ...
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              ...
                              // color: Colors.pink,
                              color: model.issue=="Morning" ? Colors.green : model.issue=="Evening" ? Colors.orange : model.issue=="Annually" ? Colors.cyan : Colors.deepPurpleAccent ,
                            ),
                            ...
                            child: Center(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    model.issue=="Morning" ? "Morning" : model.issue=="Evening" ? "Evening" : model.issue=="Annually" ? "Annually" : model.issue=="Monthly" ? "Monthly" : "Evening", style: TextStyle(fontSize: 15.0, color: Colors.white, fontWeight: FontWeight.normal),
                                  ),
                                  // Text(
