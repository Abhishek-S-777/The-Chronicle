...
import 'package:thechronicle/src/Counters/changeAddresss.dart';
import 'package:thechronicle/src/Orders/placeOrderPayment.dart';
import 'package:thechronicle/src/PaymentGateway/razorpayPayment.dart';
import 'package:thechronicle/src/chroniclehero/colored_card_page.dart';
...
import 'package:thechronicle/src/widgets/wideButton.dart';
          ...
          children: [
            ...
            widget.value == Provider.of<AddressChanger>(context).count
                ? WideButton(
                    ...
                    message: "Choose a Subscription type",
                    onPressed: ()
                    {
                      ...
                      //
                      Route route = MaterialPageRoute(builder: (c) => ColoredCardPage(
                        addressId: widget.addressId,
                        totalAmount: widget.totalAmount,
                        model1: widget.model,
