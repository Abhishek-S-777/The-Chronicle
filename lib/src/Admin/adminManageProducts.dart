...
import 'package:thechronicle/src/Admin/adminUpdateProducts.dart';
...
class _ManageProductsState  extends State<ManageProducts>  with AutomaticKeepAliveClientMixin<ManageProducts> {
  ...
  String _chosenValue1; //for the dropdown menu
  String _chosenValue2; //for the dropdown menu
  String _chosenValue3; //for the dropdown menu
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: DropdownButton<String>(
                ...
                hint: Text(
                  "Please choose an issue time/type",
                  style: TextStyle(
                      color: Colors.deepPurpleAccent,
                      fontSize: 16,
                      fontWeight: FontWeight.w600),
  ...
  saveProductInfo(String downloadUrl)
  {
    ...
    itemsRef.doc(productId).set({
      ...
      "category" : _chosenValue1.toString(),
      "issue" : _chosenValue2.toString(),
