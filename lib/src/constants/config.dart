...
class respawn{
  ...
  //for hero
  static final String heroName = 'name';
  static final String heroEmail = 'email';
  static final String heroPhno = 'phoneNo';
  static final String herPhotoUrl = 'photoUrl';
  static final String heroUID = 'uid';
  static final String heroAvatarUrl = 'url';
